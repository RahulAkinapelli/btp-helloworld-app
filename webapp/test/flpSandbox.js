		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtphelloworldui6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldui6-display": {
								"semanticObject": "sapbtphelloworldui6",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldui6",
									"url": sap.ui.require.toUrl("sap/btp/helloworldui6")
								}
							}
						}
					}
